...
struct NetworkSyncClientState: Codable, Sendable {
    ...
    init(
        ...
        self.pendingDeletionPaths = pendingDeletionPaths
    }

    private enum CodingKeys: String, CodingKey {
        case knownEntries
        case materializedPaths
        case pendingDeletionPaths
    }
    ...
    init(from decoder: Decoder) throws {
        ...
        pendingDeletionPaths = try container.decodeIfPresent(Set<String>.self, forKey: .pendingDeletionPaths) ?? []
    }
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encode(pendingDeletionPaths, forKey: .pendingDeletionPaths)
    }
}
